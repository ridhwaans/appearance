...
set_font_by_name() {
  ...
  case "$name" in
    "Roboto Mono")
      set_font "RobotoMonoForPowerline-Regular" "Roboto Mono for Powerline.ttf" "https://github.com/powerline/fonts/raw/master/RobotoMono/Roboto%20Mono%20for%20Powerline.ttf" "'Roboto Mono for Powerline', Menlo, Monaco, 'Courier New', monospace" "Roboto Mono for Powerline"
      ;;
    "SF Mono")
